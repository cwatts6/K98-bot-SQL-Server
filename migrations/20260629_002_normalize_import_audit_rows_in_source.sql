/*
MigrationId: 20260629_002_normalize_import_audit_rows_in_source
Purpose: Allow terminal import audit writers to populate RowsInSource after parsing
Author: cwatts
...
PostValidationQuery: Verify dbo.usp_ImportAudit_CompleteBatch and dbo.usp_ImportAudit_FailBatch accept @RowsInSource
RelatedBotPR:
RelatedSQLPR:
*/
