/*
MigrationId: 20260717_001_add_personal_stats_daily_contract
Purpose: Add the bounded read-only daily source contract for private personal period performance
Author: cwatts
CreatedUtc: 2026-07-17
RequiresBackup: Yes
RiskLevel: Medium
Rollback: Included
RollbackScript: migrations/rollback/20260717_001_add_personal_stats_daily_contract_rollback.sql
TransactionMode: Auto
DataChange: No
DataSafetyPlan: Not Required
EstimatedRowsAffected: N/A
PreValidationQuery: SELECT TYPE_ID(N'dbo.IntList') AS IntListType, OBJECT_ID(N'dbo.KingdomScanData4', N'U') AS StatsTable, OBJECT_ID(N'dbo.AllianceActivitySnapshotRow', N'U') AS ActivityRows, OBJECT_ID(N'dbo.cur_RallyDaily', N'U') AS FortsTable;
