/*
RollbackForMigrationId: 20260726_001_phase3_import_concurrency_and_direct_type_alignment
Purpose: Restore the pre-Phase-3 procedure definitions and direct downstream float contracts before any Phase 3 import commits
Author: cwatts
CreatedUtc: 2026-07-26
RiskLevel: High
DataLossRisk: Refused after any Phase 3 import receipt exists; otherwise metadata-only
RollbackType: Full before first Phase 3 import; forward fix or restore decision after new writes
RequiresBackup: Yes
PreRollbackValidation: Require dbo.KS4_ImportFileReceipt to exist and contain zero rows
PostRollbackValidation: Confirm restored float metadata, pre-Phase-3 procedure definitions, and removal of Phase 3 receipt/archive objects
RelatedSQLPR:
*/
...
IF @MigrationLockResult < 0
    THROW 51950, 'Phase 3 rollback could not acquire the KingdomScanData4 migration mutex within 60000 ms.', 1;

IF OBJECT_ID(N'dbo.KS4_ImportFileReceipt', N'U') IS NULL
    THROW 51951, 'Phase 3 rollback could not find the import receipt table.', 1;

IF EXISTS (SELECT 1 FROM dbo.KS4_ImportFileReceipt)
    THROW 51952, 'Phase 3 rollback is refused after a Phase 3 import receipt exists; use a reviewed forward fix or restore decision.', 1;
GO

-- GENERATED ROLLBACK PROCEDURE DEFINITIONS BEGIN
-- Rollback source: sql_schema/dbo.IMPORT_STAGING_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.UPDATE_ALL.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
-- Rollback source: sql_schema/dbo.CREATE_DASH.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
DROP TABLE IF EXISTS #Aggregated;
 ...
 END;
GO
-- Rollback source: sql_schema/dbo.UPDATE_ALL2.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.CREATE_DELTA_TABLES.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.DEADSSUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.FIX_IMPORT_STAGING.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
JOIN LatestScan AS K ON I.[Governor ID] = K.GovernorID;
	...
	END;
GO
-- Rollback source: sql_schema/dbo.HEALEDSUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.HEALEDSUMMARY_PROC_OPT.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.KILLPOINTSSUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.KILLSSUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.KT4SUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.KT5SUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.POWERSUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.RANGEDSUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.Refresh_PlayerScanMeta.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
-- Rollback source: sql_schema/dbo.sp_ExcelOutput_ByKVK.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.sp_Rebuild_ExcelForDashboard.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.sp_TARGETS_MASTER.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.SUMMARY_PROC.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.TARGETS.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.TARGETS_NEW.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.TEST.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
-- Rollback source: sql_schema/dbo.usp_BackfillKvkFinalReportCompletion.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.usp_GetLeadershipPlayerIdentityHistory.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
-- Rollback source: sql_schema/dbo.usp_GetLeadershipPlayerLastActive.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
-- Rollback source: sql_schema/dbo.usp_GetLeadershipPlayerLookupDirectory.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.usp_GetLeadershipPlayerReview.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
-- Rollback source: sql_schema/dbo.usp_LeadershipPlayerGovernorExists.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- Rollback source: sql_schema/dbo.usp_UpsertGovernorNameHistoryForScan.StoredProcedure.sql at b6b0bc497f4869e6646f6758f3a3e09b28a8a3d4
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
-- GENERATED ROLLBACK PROCEDURE DEFINITIONS END

IF OBJECT_ID(N'dbo.ARCHIVE_IMPORT_STAGING_FILE', N'P') IS NOT NULL
    DROP PROCEDURE dbo.ARCHIVE_IMPORT_STAGING_FILE;

IF OBJECT_ID(N'dbo.IMPORT_STAGING_PROC_CORE', N'P') IS NOT NULL
    DROP PROCEDURE dbo.IMPORT_STAGING_PROC_CORE;

IF OBJECT_ID(N'dbo.HASH_KS4_IMPORT_ARCHIVE_FILE', N'P') IS NOT NULL
    DROP PROCEDURE dbo.HASH_KS4_IMPORT_ARCHIVE_FILE;

IF OBJECT_ID(N'dbo.ACQUIRE_KS4_IMPORT_LOCK', N'P') IS NOT NULL
    DROP PROCEDURE dbo.ACQUIRE_KS4_IMPORT_LOCK;

IF DATABASE_PRINCIPAL_ID(N'K98ImportLockPrincipal') IS NOT NULL
    DROP ROLE K98ImportLockPrincipal;

IF OBJECT_ID(N'dbo.PK_PlayerScanMeta', N'PK') IS NOT NULL
    ALTER TABLE dbo.PlayerScanMeta DROP CONSTRAINT PK_PlayerScanMeta;

ALTER TABLE dbo.PlayerScanMeta ALTER COLUMN GovernorID float NOT NULL;
ALTER TABLE dbo.PlayerScanMeta ALTER COLUMN FirstScanOrder float NULL;
ALTER TABLE dbo.PlayerScanMeta ALTER COLUMN LastScanOrder float NULL;
...
ALTER TABLE dbo.SUMMARY_PROC_STATE ALTER COLUMN LastScanOrder float NULL;
ALTER TABLE dbo.STAGING_STATS ALTER COLUMN GovernorID float NOT NULL;
ALTER TABLE dbo.STAGING_STATS ALTER COLUMN PowerRank float NOT NULL;

DROP TABLE dbo.KS4_ImportFileReceipt;
...
(
    ...
    (
        VALUES
            (OBJECT_ID(N'dbo.PlayerScanMeta'), N'GovernorID', TYPE_ID(N'float')),
            (OBJECT_ID(N'dbo.PlayerScanMeta'), N'FirstScanOrder', TYPE_ID(N'float')),
            (OBJECT_ID(N'dbo.PlayerScanMeta'), N'LastScanOrder', TYPE_ID(N'float')),
            (OBJECT_ID(N'dbo.SUMMARY_PROC_STATE'), N'LastScanOrder', TYPE_ID(N'float')),
            (OBJECT_ID(N'dbo.STAGING_STATS'), N'GovernorID', TYPE_ID(N'float')),
            (OBJECT_ID(N'dbo.STAGING_STATS'), N'PowerRank', TYPE_ID(N'float'))
    ...
    THROW 51953, 'Phase 3 rollback post-validation found an unexpected restored column type.', 1;

IF OBJECT_ID(N'dbo.KS4_ImportFileReceipt', N'U') IS NOT NULL
   OR OBJECT_ID(N'dbo.ARCHIVE_IMPORT_STAGING_FILE', N'P') IS NOT NULL
   OR OBJECT_ID(N'dbo.IMPORT_STAGING_PROC_CORE', N'P') IS NOT NULL
   OR OBJECT_ID(N'dbo.HASH_KS4_IMPORT_ARCHIVE_FILE', N'P') IS NOT NULL
   OR OBJECT_ID(N'dbo.ACQUIRE_KS4_IMPORT_LOCK', N'P') IS NOT NULL
   OR DATABASE_PRINCIPAL_ID(N'K98ImportLockPrincipal') IS NOT NULL
    THROW 51954, 'Phase 3 rollback did not remove the receipt/archive objects.', 1;

COMMIT TRANSACTION;
GO

SELECT N'phase3_import_concurrency_and_direct_type_alignment_rollback' AS EvidenceSection,
