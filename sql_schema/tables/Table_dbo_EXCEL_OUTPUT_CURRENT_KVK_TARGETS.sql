...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_OUTPUT_CURRENT_KVK_TARGETS]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_OUTPUT_CURRENT_KVK_TARGETS](
	[Rank] [float] NOT NULL,
