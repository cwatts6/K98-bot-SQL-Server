...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_OUTPUT_KVK_TARGETS_3]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_OUTPUT_KVK_TARGETS_3](
	[Rank] [int] NULL,
	[RANK2] [int] NULL,
	[Gov_ID] [bigint] NULL,
	...
	[DKP Target] [int] NULL,
	[Kills KVK 2] [int] NULL,
	[DEADS KVK 2] [int] NULL,
	[DKP KVK 2] [int] NULL,
	[% DKP Target KVK 2] [float] NULL,
	[Kills KVK 1] [int] NULL,
	[DEADS KVK 1] [int] NULL,
	[DKP KVK 1] [int] NULL,
