...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_OUTPUT_CURRENT_KVK_TARGETS_NEW]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_OUTPUT_CURRENT_KVK_TARGETS_NEW](
	[Rank] [float] NOT NULL,
	[RANK2] [bigint] NULL,
