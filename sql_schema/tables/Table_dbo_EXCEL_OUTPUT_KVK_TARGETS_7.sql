...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_OUTPUT_KVK_TARGETS_7]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_OUTPUT_KVK_TARGETS_7](
	[Rank] [int] NULL,
	[RANK2] [int] NULL,
	[Gov_ID] [bigint] NULL,
	...
	[Kills KVK 5] [int] NULL,
	[DEADS KVK 5] [int] NULL,
	[DKP KVK 5] [int] NULL,
	[% DKP Target KVK 5] [float] NULL
) ON [PRIMARY]
END
