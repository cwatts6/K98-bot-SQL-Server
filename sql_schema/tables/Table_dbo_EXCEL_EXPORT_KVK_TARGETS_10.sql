...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_EXPORT_KVK_TARGETS_10]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_EXPORT_KVK_TARGETS_10](
	[Rank] [bigint] NULL,
	...
	[Kills KVK 9] [float] NULL,
	[DEADS KVK 9] [float] NULL,
	[DKP KVK 9] [float] NULL,
	[% DKP Target KVK 9] [float] NULL,
	[BLANK3] [varchar](1) COLLATE Latin1_General_CI_AS NOT NULL,
	[Kills KVK 8] [float] NULL,
	[DEADS KVK 8] [float] NULL,
	[DKP KVK 8] [float] NULL,
