 ...
 SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        ;WITH LatestPerGov AS (
            SELECT k.GovernorID, k.GovernorName, k.PowerRank, k.[T4&T5_KILLS],
        ...
        FROM dbo.KILLSUMMARY AS K 
        WHERE K.POWERRank <= 50
          AND K.GovernorID NOT IN (999999997, 999999998, 999999999);
