...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_EXPORT_KVK_TARGETS_15]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_EXPORT_KVK_TARGETS_15](
	[Rank] [bigint] NULL,
