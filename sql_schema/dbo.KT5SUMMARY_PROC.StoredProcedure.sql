...
SET NOCOUNT ON;
    ...
    BEGIN TRY
        ...
        DELETE FROM dbo.K5ALL WHERE GovernorID IN (SELECT GovernorID FROM #AffectedGovs);
        ...
        DELETE FROM dbo.K512 WHERE GovernorID IN (SELECT GovernorID FROM #AffectedGovs);
        ...
        DELETE FROM dbo.K56 WHERE GovernorID IN (SELECT GovernorID FROM #AffectedGovs);
        ...
        DELETE FROM dbo.K53 WHERE GovernorID IN (SELECT GovernorID FROM #AffectedGovs);
        ...
        DELETE FROM dbo.K53D WHERE GovernorID IN (SELECT GovernorID FROM #AffectedGovs);
        ...
        DELETE FROM dbo.K56D WHERE GovernorID IN (SELECT GovernorID FROM #AffectedGovs);
        ...
        DELETE FROM dbo.K512D WHERE GovernorID IN (SELECT GovernorID FROM #AffectedGovs);
