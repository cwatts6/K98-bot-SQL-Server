...
END
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[KILLSUMMARY]') AND name = N'UX_KILLSUMMARY_GovernorID')
CREATE UNIQUE NONCLUSTERED INDEX [UX_KILLSUMMARY_GovernorID] ON [dbo].[KILLSUMMARY]
(
	[GovernorID] ASC
