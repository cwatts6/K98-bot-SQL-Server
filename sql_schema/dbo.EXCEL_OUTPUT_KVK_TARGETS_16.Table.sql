...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_OUTPUT_KVK_TARGETS_16]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_OUTPUT_KVK_TARGETS_16](
	[Rank] [int] NULL,
	[RANK2] [int] NULL,
	[Gov_ID] [bigint] NULL,
	...
	[DKP Target] [int] NULL,
	[Kills KVK 15] [int] NULL,
	[DEADS KVK 15] [int] NULL,
	[DKP KVK 15] [int] NULL,
	[% DKP Target KVK 15] [float] NULL,
	[Kills KVK 14] [int] NULL,
	[DEADS KVK 14] [int] NULL,
	[DKP KVK 14] [int] NULL,
	[% DKP Target KVK 14] [float] NULL
) ON [PRIMARY]
END
