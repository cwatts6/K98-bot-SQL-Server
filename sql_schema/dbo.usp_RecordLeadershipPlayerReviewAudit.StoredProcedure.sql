...
CREATE OR ALTER PROCEDURE dbo.usp_RecordLeadershipPlayerReviewAudit
    @ActorDiscordID bigint, @TargetGovernorID bigint = NULL,
    @GuildID bigint, @ChannelID bigint,
    @AuthorizationBasis nvarchar(32), @AuthorizationRoleID bigint = NULL,
    @Action nvarchar(32), @Outcome nvarchar(24), @ErrorCode nvarchar(48) = NULL,
    @RequestCorrelationID uniqueidentifier, @ExecutedAtUtc datetime2(3) = NULL
...
BEGIN
    ...
    IF @Action NOT IN (N'open', N'ambiguity_select', N'page_change', N'period_change',
        N'linked_governor_change', N'change_player', N'definitions', N'refresh')
        THROW 51406, 'Leadership review audit action is invalid.', 1;
    IF @Outcome NOT IN (N'ALLOWED', N'DENIED', N'SUCCEEDED', N'FAILED',
