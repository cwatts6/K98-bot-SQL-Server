...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_OUTPUT_KVK_TARGETS_JAN25]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_OUTPUT_KVK_TARGETS_JAN25](
	[Rank] [float] NOT NULL,
	[RANK2] [bigint] NULL,
	...
	[Kills_for_May24 KVK] [float] NULL,
	[DEADS_for_May24 KVK] [float] NULL,
	[DKP_For_May24 KVK] [float] NULL,
	[% of DKP Target For May24 KVK] [float] NULL
) ON [PRIMARY]
END
