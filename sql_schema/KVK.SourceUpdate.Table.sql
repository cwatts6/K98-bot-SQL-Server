...
-- S8B no-fight amendment reference snapshot; deploy the reviewed migration, not this file.
...
(
    ...
    CONSTRAINT FK_SourceUpdate_Kind FOREIGN KEY (SourceKey, KVK_NO, PeriodKey, PeriodKind) REFERENCES KVK.SourcePeriod (SourceKey, KVK_NO, PeriodKey, PeriodKind),
    ...
    CONSTRAINT CK_SourceUpdate_PeriodMode CHECK (DATALENGTH(PeriodKind) = LEN(PeriodKind) AND PeriodKind IN ('fight','overall','no_fight') AND (UpdateKind = PeriodKind OR (PeriodKind = 'fight' AND UpdateKind = 'no_fight'))),
