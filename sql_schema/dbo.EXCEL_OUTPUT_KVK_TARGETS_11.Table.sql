...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EXCEL_OUTPUT_KVK_TARGETS_11]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EXCEL_OUTPUT_KVK_TARGETS_11](
	[Rank] [int] NULL,
	[RANK2] [int] NULL,
	[Gov_ID] [bigint] NULL,
	...
	[DKP Target] [int] NULL,
	[Kills KVK 10] [int] NULL,
	[DEADS KVK 10] [int] NULL,
	[DKP KVK 10] [int] NULL,
	[% DKP Target KVK 10] [float] NULL,
	[Kills KVK 9] [int] NULL,
	[DEADS KVK 9] [int] NULL,
	[DKP KVK 9] [int] NULL,
