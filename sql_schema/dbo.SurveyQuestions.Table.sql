...
ALTER TABLE [dbo].[SurveyQuestions]  WITH CHECK ADD  CONSTRAINT [CK_SurveyQuestions_Cardinality] CHECK  (([QuestionType]='Text' AND [MinSelections]=(0) AND [MaxSelections]=(0) AND [AllowDetails]=(0) OR [QuestionType]<>'Text' AND [MinSelections]>=(1) AND [MaxSelections]>=[MinSelections] AND [MaxSelections]<=(6) AND ([QuestionType]<>'SingleChoice' OR [MinSelections]=(1) AND [MaxSelections]=(1)) AND ([QuestionType]<>'MultiSelect' OR [MaxSelections]>=(2))))
...
ALTER TABLE [dbo].[SurveyQuestions]  WITH CHECK ADD  CONSTRAINT [CK_SurveyQuestions_Type] CHECK  (([QuestionType]='Text' OR [QuestionType]='MultiSelect' OR [QuestionType]='SingleChoice'))
