...
CREATE TABLE [dbo].[ArkConfig](
	...
	[AdminOverrideBanRule] [bit] NOT NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_ArkConfig_AdminOverrideBanRule]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[ArkConfig] ADD  CONSTRAINT [DF_ArkConfig_AdminOverrideBanRule]  DEFAULT ((0)) FOR [AdminOverrideBanRule]
END
