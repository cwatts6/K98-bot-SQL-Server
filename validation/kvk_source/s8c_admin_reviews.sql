...
BEGIN TRY
    ...
    VALUES (@ReviewID,2000000001,'choose_source',N'synthetic-admin',N'synthetic-guild',N'synthetic-channel',1,'pending',N'{"source":"snapshot_report_v1"}',CONVERT(binary(32),0x01),'2000-01-01','2000-01-02');
